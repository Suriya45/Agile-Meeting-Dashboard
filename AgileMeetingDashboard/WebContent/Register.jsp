...
<body>
	<form action="Registercontroller" method="post">
		<div class="menu">
			<a href="contact.jsp">Contact</a> <a href="aboutus.jsp">About us</a>
		...
		<center>
			<h1>
				Agile<span style="color: #e6b800"> Meeting Dashboard</span>
			</h1>
		</center>
		<h2>
			Account
				...
				<center>
					<input id="email" style="text-indent: 20px;" type="email"
						name="emailid" placeholder="Email"><br>
					</center>
						<center>
							<input id="password" style="text-indent: 20px;" type="password"
								...
								<center>
									<input id="confirmpass" style="text-indent: 20px;"
										type="password" name="confirm" placeholder="Confirm password"><br>
									</center>
										<center>
											<input id="contact" style="text-indent: 20px;" type="text"
												...
												<center>
													<input id="DOB" style="text-indent: 20px;" type="date"
														name="dob"><br>
													</center>
														<center>
