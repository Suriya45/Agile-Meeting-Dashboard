    ...
    public Registercontroller() {
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
		{
			...
			try
			{
				...
				Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/students?useSSL=false","root","root");
			...
			out.println("alert('Sign Up Successful, Login to continue');");  
			out.println("</script>");
